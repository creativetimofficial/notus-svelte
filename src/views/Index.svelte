  ...
  <div class="container mx-auto items-center flex flex-wrap">
    <div class="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
      <div class="pt-32 sm:pt-0">
        <h2 class="font-semibold text-4xl text-coolGray-600">
        ...
        <div class="mt-12">
          ...
          <a
            ...
            class="github-star ml-1 text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-coolGray-700 active:bg-coolGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
            target="_blank"
          >
            Github Star
          </a>
...
<section class="mt-48 md:mt-40 pb-40 relative bg-coolGray-100">
  <div
  ...
  >
    ...
    >
      <polygon
        class="text-coolGray-100 fill-current"
          ...
          <div class="w-full md:w-6/12 px-4">
            <div class="relative flex flex-col mt-4">
              <div class="px-4 py-5 flex-auto">
                <div
                  class="text-coolGray-500 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white"
                >
                ...
                <p class="mb-4 text-coolGray-500">
  ...
  <div class="container mx-auto overflow-hidden pb-20">
    <div class="flex flex-wrap items-center">
      <div class="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
        ...
        <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-coolGray-600">
        ...
        <div class="block pb-6">
          <span
            class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-coolGray-500 bg-white uppercase last:mr-0 mr-2 mt-2"
          >
            Buttons
          </span>
          <span
        ...
        <a
          ...
          target="_blank"
          class="font-bold text-coolGray-700 hover:text-coolGray-500 ease-linear transition-all duration-150"
        >
          View All
      ...
      <div class="w-full md:w-6/12 px-4 mr-auto ml-auto mt-32">
        <div class="justify-center flex flex-wrap relative">
          <div class="my-4 w-full lg:w-6/12 px-4">
            ...
            >
              <div
                class="bg-coolGray-700 shadow-lg rounded-lg text-center p-8 mt-8"
              >
                <img
                  alt="..."
                  class="shadow-md rounded-full max-w-full w-16 mx-auto p-2 bg-white"
  ...
  <div class="justify-center text-center flex flex-wrap mt-24">
    <div class="w-full md:w-6/12 px-12 md:px-4">
      ...
      <p class="text-lg leading-relaxed mt-4 mb-4 text-coolGray-500">
...
<section class="block relative z-1 bg-coolGray-600">
  <div class="container mx-auto">
...
<section class="py-20 bg-coolGray-600 overflow-hidden">
  <div class="container mx-auto pb-64">
    <div class="flex flex-wrap justify-center">
      <div class="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
        ...
        <p class="text-lg font-light leading-relaxed mt-4 mb-4 text-coolGray-400">
          Since
          <a
            href="https://tailwindcss.com/?ref=creativetim"
            class="text-coolGray-300"
            target="_blank"
          >
            Tailwind CSS
          </a>
        ...
        <p class="text-lg font-light leading-relaxed mt-0 mb-4 text-coolGray-400">
          Get it free on Github and please help us spread the news with a Star!
        </p>
        <a
          href="https://github.com/creativetimofficial/notus-svelte?ref=ns-index"
          target="_blank"
          class="github-star mt-4 inline-block text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-coolGray-700 active:bg-coolGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
        >
          Github Star
        </a>
      </div>
      ...
      <div class="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
        <i
          class="fab fa-github text-coolGray-700 text-55 absolute -top-150-px -right-100 left-auto opacity-80"
        ></i>
      </div>
    </div>
  </div>
...
<section class="pb-16 bg-coolGray-200 relative pt-32">
  <div
    class="-mt-20 top-0 bottom-auto left-0 right-0 w-full absolute h-20"
    style="transform: translateZ(0);"
  >
  ...
  <div class="container mx-auto">
    ...
    >
      <div class="w-full text-center lg:w-8/12">
        ...
        <p class="text-coolGray-500 text-lg leading-relaxed mt-4 mb-4">
        ...
        <div class="sm:block flex flex-col mt-10">
          ...
          <a
            href="https://github.com/creativetimofficial/notus-svelte?ref=ns-index"
            target="_blank"
            class="github-star sm:ml-1 text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-coolGray-700 active:bg-coolGray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
          >
