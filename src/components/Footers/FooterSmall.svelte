    ...
    <div class="flex flex-wrap items-center md:justify-between justify-center">
      <div class="w-full md:w-4/12 px-4">
        ...
        >
          Copyright © {date}
          <a
            href="https://www.creative-tim.com?ref=tws-footer-small"
      ...
      <div class="w-full md:w-8/12 px-4">
        <ul class="flex flex-wrap list-none md:justify-end justify-center">
          ...
          <li>
            <a
              href="https://www.creative-tim.com/presentation?ref=tws-footer-small"
              class="text-white hover:text-gray-400 text-sm font-semibold block py-1 px-3"
            >
              About Us
            </a>
          ...
          <li>
            <a
              href="http://blog.creative-tim.com?ref=tws-footer-small"
              class="text-white hover:text-gray-400 text-sm font-semibold block py-1 px-3"
            >
              Blog
            </a>
          ...
          <li>
            <a
              href="https://github.com/creativetimofficial/vue-tailwind-webapp/blob/master/LICENSE.md?ref=tws-footer-small"
              class="text-white hover:text-gray-400 text-sm font-semibold block py-1 px-3"
            >
              MIT License
            </a>
